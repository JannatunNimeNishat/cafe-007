...
const MenuItemDetails = () => {
    ...
    return (
        ...
        <div>
            ...
            {/* details */}
            <div className="mt-[27px] flex items-center gap-10 my-container">
                {/* left */}
                <div>
                    <figure className="w-[594px] h-[334px]">
                        <img className="h-full w-full" src={food_img?.image_1} alt="" />
                    </figure>
                    <div className="flex items-center justify-center border gap-3 mt-2">
                        <figure className="w-[287px] h-[202px]">
